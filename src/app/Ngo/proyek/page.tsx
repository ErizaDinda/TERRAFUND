...
export default function NgoProyekPage() {
  ...
  // 1. DATA STATISTIK
  const stats = [
    { label: "Total Proyek", value: "8 Proyek", icon: <LayoutDashboard size={20} />, color: "bg-blue-100 text-blue-600" },
    { label: "Dana Terkumpul", value: "Rp 735 Jt", icon: <Coins size={20} />, color: "bg-green-100 text-green-600" },
    { label: "Relawan Aktif", value: "415 Org", icon: <Users size={20} />, color: "bg-yellow-100 text-yellow-600" },
  ];
    ...
    <main className="w-full pb-24 bg-gray-50 min-h-screen">
      ...
      <section className="w-full bg-gradient-to-r from-indigo-600 to-purple-600 px-6 py-16 pb-24 text-white shadow-lg">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          {/* ✅ FIXED: Tombol Link ke Buat Proyek Baru */}
          <Link
